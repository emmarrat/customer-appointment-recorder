...
export const createExpert = createAsyncThunk<void, ExpertMutation, { rejectValue: ValidationError }>(
...
export const updateExpert = createAsyncThunk<void, { id: string, expertData: ExpertMutation }, {
  rejectValue: ValidationError,
  state: RootState
}>(
  'experts/updateExpert',
  async ({id, expertData}, {rejectWithValue}) => {
    const formData = new FormData();
    const keys = Object.keys(expertData) as (keyof ExpertMutation)[];
